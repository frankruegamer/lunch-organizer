...
('1', 'Pizza Margherita', 'mit Tomaten und Käse', 6.00, (SELECT id FROM restaurant)),
('2', 'Pizza Vorderschinken', null, 6.50, (SELECT id FROM restaurant)),
('3', 'Pizza Salami', null, 6.50, (SELECT id FROM restaurant)),
('4', 'Pizza Peperoniwurst', null, 6.50, (SELECT id FROM restaurant)),
('5', 'Pizza Champignons', null, 6.50, (SELECT id FROM restaurant)),
('6', 'Pizza Paprika', null, 6.50, (SELECT id FROM restaurant)),
('7', 'Pizza Broccoli', null, 6.50, (SELECT id FROM restaurant)),
('8', 'Pizza Artischocken', null, 6.50, (SELECT id FROM restaurant)),
('9', 'Pizza Spinat mit Hirtenkäse', null, 7.00, (SELECT id FROM restaurant)),
('10', 'Pizza Leo', 'mit Vorderschinken und Peperoniwurst', 7.00, (SELECT id FROM restaurant)),
('11', 'Pizza Roma', 'mit Vorderschinken und Salami', 7.00, (SELECT id FROM restaurant)),
('12', 'Pizza Salame Funghi', 'mit Salami, Champignons', 7.00, (SELECT id FROM restaurant)),
('13', 'Pizza Peperoniwurst Funghi', 'mit Peperoniwurst und Champignons', 7.00, (SELECT id FROM restaurant)),
('14', 'Pizza Prosciuto Funghi', 'mit Vorderschinken und Champignons', 7.00, (SELECT id FROM restaurant)),
('15', 'Pizza Regina', 'mit Vorderschinken und Paprika', 7.00, (SELECT id FROM restaurant)),
('17', 'Pizza Hawaii', 'mit Vorderschinken und Ananas', 7.00, (SELECT id FROM restaurant)),
('18', 'Pizza Mozzarella', 'mit frischen Tomaten, Mozzarella und Basilikum', 7.00, (SELECT id FROM restaurant)),
('19', 'Pizza Mista', 'mit Vorderschinken, Salami und Champignons', 7.50, (SELECT id FROM restaurant)),
('20', 'Pizza Navi', 'mit Vorderschinken, Salami, Peperoniwurst und Champignons', 7.50, (SELECT id FROM restaurant)),
('21', 'Pizza Vier Jahreszeiten', 'mit Vorderschinken, Salami, Paprika und Champignons', 7.50, (SELECT id FROM restaurant)),
('22', 'Pizza Italia', 'mit Vorderschinken, Paprika und Spiegelei', 7.50, (SELECT id FROM restaurant)),
('23', 'Pizza Tonno Cipolle', 'mit Thunfisch, Zwiebel und Knoblauch', 7.50, (SELECT id FROM restaurant)),
('24', 'Pizza Frutti di Mare', 'mit Meeresfrüchten', 8.00, (SELECT id FROM restaurant)),
('25', 'Pizza Sardellen', 'mit Sardellen, Kapern und Zwiebeln', 7.50, (SELECT id FROM restaurant)),
('26', 'Pizza Capricciosa', 'mit Vorderschinken, Champignons, Oliven und Artischocken', 7.50, (SELECT id FROM restaurant)),
('27', 'Pizza Diavolo', 'mit Peperoniwurst, grüne Peperoni und Paprika', 7.50, (SELECT id FROM restaurant)),
('28', 'Pizza Bobbynulls', 'mit frischen Tomaten, Spinat und Mozzarella', 7.50, (SELECT id FROM restaurant)),
('29', 'Pizza Vegetarisch', 'mit Champignons, Paprika, Artischocken, Broccoli, Spinat, grüne Peperoni, Zwiebeln und Oliven', 8.00, (SELECT id FROM restaurant)),
('30', 'Pizza Speciale', 'mit Vorderschinken, Salami, Peperoniwurst, Oliven, Champignons, grüne Peperoni, Paprika und Zwiebeln', 8.00, (SELECT id FROM restaurant)),
('31', 'Pizza Milano (scharf)', 'mit Vorderschinken, Salami, Hackfleisch, Zwiebeln, Jalapenos und Knoblauch', 8.00, (SELECT id FROM restaurant)),
('32', 'Pizza Mexicana (scharf)', 'mit Peperoniwurst, Champignons, Paprika, Kidney Bohnen, Mais, Knoblauch und Jalapenos', 8.00, (SELECT id FROM restaurant)),
('33', 'Pizza Santana (scharf)', 'Hähnchenbrustfilet, Hirtenkäse, Zwiebeln, grüne Peperoni und Chili', 8.00, (SELECT id FROM restaurant)),
('34', 'Pizza Hähnchen-Gyros', 'mit Hähnchenbrustfilet, Curry und Zwiebeln', 7.50, (SELECT id FROM restaurant)),
('35', 'Pizza Holondaise (scharf)', 'mit Vorderschinken, Salami, Hähnchenbrustfilet, Paprika, Zwiebeln, Chili und Sauce Holondaise', 8.00, (SELECT id FROM restaurant)),
('36', 'Pizza Barbecue', 'mit Hähnchenbrustfilet, Zwiebeln, Paprika und BBQ-Sauce', 8.00, (SELECT id FROM restaurant)),
('37', 'Pizza Texas', 'mit Peperoniwurst, Paprika, Mozzarella und BBQ-Sauce', 8.00, (SELECT id FROM restaurant)),
('38', 'Pizza Mumbai', 'mit Salami, Mais, Hähnchenbrustfilet und Zwiebeln', 8.00, (SELECT id FROM restaurant)),
('39', 'Pizza Quadro Formagi', 'mit Edamer, Hirtenkäse, Gorgonzola und Mozzarella', 8.00, (SELECT id FROM restaurant)),
('40', 'Pizza Calzone', 'mit Vorderschinken, Salami und Champignons gefüllt', 8.00, (SELECT id FROM restaurant)),
...
('43', 'Pizza Mafia', 'mit Vorderschinken, Hackfleisch, Hirtenkäse und grüne Peperoni, scharf', 8.00, (SELECT id FROM restaurant)),
